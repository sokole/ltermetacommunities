...
# SBC-sessile-invert-Lamy-Castorani                         #
...
# SBC LTER (Santa Barbara Coastal): Sessile inverts
data.set <- "SBC-sessile-invert"
...
write.csv(out_long, file = "~/Google Drive File Stream/My Drive/LTER Metacommunities/LTER-DATA/L3-aggregated_by_year_and_space/L3-sbc-sessile-inverts-castorani.csv", row.names = F)
