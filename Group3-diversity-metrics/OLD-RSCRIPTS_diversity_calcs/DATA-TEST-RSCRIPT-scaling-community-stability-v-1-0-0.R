...
# -- TEST ----
# try reading data set from google drive and calculating local and regional compositional turnover
# and scaling metric (phi_)
try_result <- try({
...
# gamma_temporal_bd should be between 0 and 1
# mean_alpha_temporal_bd should be between 0 and 1
# phi_bd shoudl be between 0 and 1
