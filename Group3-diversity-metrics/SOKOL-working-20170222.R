...
#######################################################
id_google_data_list <- '0B2P104M94skvVEVhV3IwOF9oejA'
...
result.file.path <- file.path('Group3-diversity-metrics/dat_CVs_divpart_env.csv')
