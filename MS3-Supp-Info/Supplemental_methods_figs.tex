...
\begin{figure}[h!]
\centering
%\includegraphics[scale = 0.4]{and-plants-compagnoni_species_accumulation_curve.pdf}
%\includegraphics[scale = 0.4]{and-plants-compagnoni_num_taxa_over_time.pdf}
%\includegraphics[scale = 0.4]{and-plants-compagnoni_spatiotemporal_sampling_effort.pdf}
%\includegraphics[scale = 0.4]{and-plants-compagnoni_spp_shared.pdf}
