...
\begin{figure}[h!]
\centering
%\includegraphics[scale = 0.4]{fce-fish-Rehage_species_accumulation_curve.pdf}
%\includegraphics[scale = 0.4]{fce-fish-Rehage_num_taxa_over_time.pdf}
\includegraphics[scale = 0.4]{fce-fish-Rehage_spatiotemporal_sampling_effort.pdf}
%\includegraphics[scale = 0.4]{fce-fish-Rehage_spp_shared.pdf}
