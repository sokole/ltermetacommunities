...
#'
#'
#' @description A wrapper function for \code{vegetarian::d()} to calculate "numbers equivalents" alpha, beta, and gamma diversity indicies for each time step in a metacommunity data set. See Jost (2007) and documentation for \code{vegetarian::d()} for more information about the metrics.
#'
#'
#' @importFrom magrittr %>%
#' @import dplyr
...
divpart <- function(
  ...
  requireNamespace('vegetarian', quietly = TRUE)
